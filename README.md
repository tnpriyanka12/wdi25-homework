# WDi-25 ([General Assembly, Sydney](https://generalassemb.ly/sydney))
##Homework Repository
...
- **Clone your forked repository to your computer**
    ...
    + Make sure you're browser is open to **your** forked version of this repository on Github (eg [http://github.com/{{YOUR_USERNAME}}/wdi25-homework](http://github.com/{{YOUR_USERNAME}}/wdi25-homework)).
...
- **Add an upstream remote repository**
    ...
    + `cd wdi25-homework`
    + `git remote add upstream https://github.com/michelleerica/wdi25-homework`
...
- **Once you're finished, submit a pull request for me to accept your homework**
    + Navigate to your forked version of this repository on Github (eg [https://github.com/{{YOUR_USERNAME_HERE}}/wdi25-homework](https://github.com/{{YOUR_USERNAME_HERE}}/wdi25-homework)).
