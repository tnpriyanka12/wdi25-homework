...
const planTripSingleLine = function (startStop, endStop) {
  let numberOfStops = lineN.indexOf(startStop) - lineN.indexOf(endStop);
// if the number of stops is negative, turn it into a postive
  if (numberOfStops < 0) {
...
console.log(planTripSingleLine('34th', 'Union Square'));
console.log(planTripSingleLine('Times Square', '8th'));



const allStationNamesSingleLine = function (startStop, endStop) {
  ...
  if (numberOfStops > 0) {
    ...
    for (let i = lineN.indexOf(startStop); i >= lineN.indexOf(endStop); i--) {
      if (i !== lineN.indexOf(startStop)) {
        stations += ', '
      }
...
console.log(allStationNamesSingleLine('34th', 'Union Square'));
...
// console.log(`You must travel through the following stops on the ${insertLine} line: ${insertStation}, ${insertStation}, ${insertStation}, ${insertStation}.`);
//
// console.log('Change at Union Square.');
//
// console.log(`Your journey continues through the following stops: ${insertStation}, ${insertStation}, ${insertStation}.`);
//
// console.log(`${insertNumberOfStops} stops in total.`)
